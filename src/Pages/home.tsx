      ...
      <div className="max-w-5xl mx-auto px-6 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          >
            ...
            <div>
              <h2 className="text-3xl font-semibold text-zinc-900 mb-2">Lesen</h2>
              <p className="text-zinc-500">Texte verstehen und Fragen beantworten.</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <h2 className="text-3xl font-semibold text-zinc-900 mb-2">Hören</h2>
              <p className="text-zinc-500">Hörverstehen trainieren mit Audiobeispielen.</p>
            </div>
          </Link>
        </div>
